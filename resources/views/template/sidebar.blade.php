<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        <div class="app-brand demo ">
            <a href="index.html" class="app-brand-link">
                ...
                <!-- <span class="app-brand-text demo menu-text fw-bolder ms-2">layanan masyrakat</span> -->
                <marquee> <h3>Aplikasi Layanan Masyarakat Online</h3></marquee>
            </a>
        ...
        <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{ e($__env->yieldContent('menu')) == 'pengaduan' ? 'active' : '' }}">
                <a href="/pengaduan" class="menu-link">
                    ...
                    <div data-i18n="Account Settings">Pengaduan</div>
                </a>
            </li>
            <!-- <li class="menu-item">
                <a href="/tanggapan" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-lock-open-alt"></i>
