    ...
    <!-- <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        <div class="app-brand demo ">
            <a href="index.html" class="app-brand-link">
                ...
                <span class="app-brand-text demo menu-text fw-bolder ms-2">Pengaduan</span>
            </a>
        ...
        <ul class="menu-inner py-1">
            ...
            <a href="/laporanku" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Laporanku</div>
            </a>
            </li>
        ...
        <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme" id="layout-navbar">
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                    ...
                    <li>
                        <a class="dropdown-item" href="{{ route('logout') }}" onClick="return confirm('Yakin ingin Hapus?')">
                ...
                <div class="col-md-2">   
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span class="fw-semibold d-block mb-1"> Total Laporan </span>
                            <h3 class="card-title text-nowrap mb-1">{{$jumlah_laporanku}}</h3>
                            <small class="text-success fw-semibold"><a href="/laporanku" class="btn btn-sm btn-outline-secondary" value="laporanku">Lihat Laporan</a></small>
                        </div>
                    </div>
                </div>
                <div class="col">   
                    <div class="card shadow">
                        ...
                        @endif
                            <form method="post" action="/pengaduan/store" enctype="multipart/form-data">
                                ...
                                <!-- <div class="form-group">
                                    <label>Na.ma</label>
                                    <input type="text" name="nik" value="{{ Auth::user()->nama }}" class="form-control" placeholder="Nama Pengadu ..">
                                </div> -->

                                <div class="form-group">
                                    <label>Laporan</label>
                                    <textarea name="isi_laporan" rows="7" class="form-control" placeholder="isi laporan .."></textarea>
